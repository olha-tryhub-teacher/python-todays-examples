...
screen.onkeypress(pen.move_left, "Left")  # стрілки — керування
screen.onkeypress(pen.move_right, "Right")
screen.onkeypress(pen.move_up, "Up")
screen.onkeypress(pen.move_down, "Down")
screen.listen()
